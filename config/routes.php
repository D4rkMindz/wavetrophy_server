...
$app->get('/api', 'App\Controller\API\ApiController:indexAction')->setName('api');
$app->post('/api/auth', 'App\Controller\API\AuthenticationController:authenticateAction')->setName('api.authenticate');
