...
class Init extends AbstractMigration
{
    public function change()
    {
        ...
        $table->addColumn('map_url', 'string', ['null' => true, 'limit' => 1000, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'coordinate_lon'])->update();
        $table->addColumn('description', 'text', ['null' => true, 'limit' => MysqlAdapter::TEXT_LONG, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'map_url'])->update();
        $table->save();
        ...
        $table->save();
        $table = $this->table("group", ['engine' => "InnoDB", 'encoding' => "utf8", 'collation' => "utf8_unicode_ci", 'comment' => ""]);
        $table->save();
        ...
        $table->addColumn('wavetrophy_hash', 'string', ['null' => false, 'limit' => 80, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'comment' => "reference to wavetrohpy.hash", 'after' => 'id'])->update();
        ...
        $table->save();
        $table = $this->table("image_has_address", ['engine' => "InnoDB", 'encoding' => "utf8", 'collation' => "utf8_unicode_ci", 'comment' => ""]);
        $table->save();
        ...
        $table->addColumn('permission_hash', 'string', ['null' => false, 'limit' => 80, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'comment' => "reference to permission.hash", 'after' => 'id'])->update();
        $table->addColumn('team_hash', 'string', ['null' => false, 'limit' => 80, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'comment' => "reference to team.hash", 'after' => 'permission_hash'])->update();
        $table->addColumn('username', 'string', ['null' => false, 'limit' => 50, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'team_hash'])->update();
        $table->addColumn('first_name', 'string', ['null' => false, 'limit' => 45, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'username'])->update();
        $table->addColumn('password', 'string', ['null' => false, 'limit' => 255, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'first_name'])->update();
        ...
        $table->addColumn('email', 'string', ['null' => true, 'limit' => 255, 'collation' => "utf8_unicode_ci", 'encoding' => "utf8", 'after' => 'language'])->update();
